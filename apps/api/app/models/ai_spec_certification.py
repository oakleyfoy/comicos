...
class AISpecCertificationRun(SQLModel, table=True):
    __tablename__ = "ai_spec_certification_run"
    __table_args__ = (
        SAIndex("ix_ai_spec_cert_run_started", "started_at", "id"),
        SAIndex("ix_ai_spec_cert_run_result", "certification_result", "id"),
    )
    ...
    input_score: float = Field(default=0.0, nullable=False)
    baseline_score: float = Field(default=0.0, nullable=False)
    ai_eval_score: float = Field(default=0.0, nullable=False)
    top20_score: float = Field(default=0.0, nullable=False)
