...
def upgrade() -> None:
    ...
    op.create_index("ix_scan_hist_comp_runs_owner", "scan_historical_comparison_runs", ["owner_user_id"], unique=False)
    op.create_index("ix_scan_hist_comp_runs_scan", "scan_historical_comparison_runs", ["scan_image_id"], unique=False)
    op.create_index("ix_scan_hist_comp_runs_recon", "scan_historical_comparison_runs", ["reconciliation_run_id"], unique=False)
    op.create_index("ix_scan_hist_comp_runs_visual", "scan_historical_comparison_runs", ["visual_evidence_run_id"], unique=False)
    op.create_index("ix_scan_hist_comp_runs_review", "scan_historical_comparison_runs", ["review_session_id"], unique=False)
    op.create_index("ix_scan_hist_comp_runs_source_ck", "scan_historical_comparison_runs", ["source_checksum"], unique=False)
    op.create_index("ix_scan_hist_comp_runs_checksum", "scan_historical_comparison_runs", ["historical_comparison_checksum"], unique=False)
    op.create_index("ix_scan_hist_comp_runs_status", "scan_historical_comparison_runs", ["comparison_status"], unique=False)
    op.create_index("ix_scan_hist_comp_runs_engine", "scan_historical_comparison_runs", ["engine_version"], unique=False)
    ...
    op.create_index("ix_scan_hist_comp_pairs_owner", "scan_historical_comparison_pairs", ["owner_user_id"], unique=False)
    op.create_index("ix_scan_hist_comp_pairs_run", "scan_historical_comparison_pairs", ["comparison_run_id"], unique=False)
    op.create_index("ix_scan_hist_comp_pairs_current_scan", "scan_historical_comparison_pairs", ["current_scan_image_id"], unique=False)
    op.create_index("ix_scan_hist_comp_pairs_prior_scan", "scan_historical_comparison_pairs", ["prior_scan_image_id"], unique=False)
    op.create_index("ix_scan_hist_comp_pairs_current_key", "scan_historical_comparison_pairs", ["current_identity_key"], unique=False)
    op.create_index("ix_scan_hist_comp_pairs_prior_key", "scan_historical_comparison_pairs", ["prior_identity_key"], unique=False)
    op.create_index("ix_scan_hist_comp_pairs_basis", "scan_historical_comparison_pairs", ["match_basis"], unique=False)
    op.create_index("ix_scan_hist_comp_pairs_conf", "scan_historical_comparison_pairs", ["match_confidence"], unique=False)
    op.create_index("ix_scan_hist_comp_pairs_current_ck", "scan_historical_comparison_pairs", ["current_checksum"], unique=False)
    op.create_index("ix_scan_hist_comp_pairs_prior_ck", "scan_historical_comparison_pairs", ["prior_checksum"], unique=False)
    ...
    op.create_index("ix_scan_hist_comp_deltas_owner", "scan_historical_comparison_deltas", ["owner_user_id"], unique=False)
    op.create_index("ix_scan_hist_comp_deltas_run", "scan_historical_comparison_deltas", ["comparison_run_id"], unique=False)
    op.create_index("ix_scan_hist_comp_deltas_pair", "scan_historical_comparison_deltas", ["pair_id"], unique=False)
    op.create_index("ix_scan_hist_comp_deltas_rank", "scan_historical_comparison_deltas", ["delta_rank"], unique=False)
    op.create_index("ix_scan_hist_comp_deltas_type", "scan_historical_comparison_deltas", ["delta_type"], unique=False)
    op.create_index("ix_scan_hist_comp_deltas_cat", "scan_historical_comparison_deltas", ["delta_category"], unique=False)
    op.create_index("ix_scan_hist_comp_deltas_dir", "scan_historical_comparison_deltas", ["delta_direction"], unique=False)
    op.create_index("ix_scan_hist_comp_deltas_conf", "scan_historical_comparison_deltas", ["confidence_score"], unique=False)
    op.create_index("ix_scan_hist_comp_deltas_sev", "scan_historical_comparison_deltas", ["severity_hint"], unique=False)
    op.create_index("ix_scan_hist_comp_deltas_region", "scan_historical_comparison_deltas", ["region_type"], unique=False)
    ...
    op.create_index("ix_scan_hist_comp_artifacts_owner", "scan_historical_comparison_artifacts", ["owner_user_id"], unique=False)
    op.create_index("ix_scan_hist_comp_artifacts_run", "scan_historical_comparison_artifacts", ["comparison_run_id"], unique=False)
    op.create_index("ix_scan_hist_comp_artifacts_type", "scan_historical_comparison_artifacts", ["artifact_type"], unique=False)
    op.create_index("ix_scan_hist_comp_artifacts_backend", "scan_historical_comparison_artifacts", ["storage_backend"], unique=False)
    op.create_index("ix_scan_hist_comp_artifacts_ck", "scan_historical_comparison_artifacts", ["artifact_checksum"], unique=False)
    ...
    op.create_index("ix_scan_hist_comp_issues_owner", "scan_historical_comparison_issues", ["owner_user_id"], unique=False)
    op.create_index("ix_scan_hist_comp_issues_run", "scan_historical_comparison_issues", ["comparison_run_id"], unique=False)
    op.create_index("ix_scan_hist_comp_issues_type", "scan_historical_comparison_issues", ["issue_type"], unique=False)
    op.create_index("ix_scan_hist_comp_issues_severity", "scan_historical_comparison_issues", ["severity"], unique=False)
    ...
    op.create_index("ix_scan_hist_comp_history_owner", "scan_historical_comparison_history", ["owner_user_id"], unique=False)
    op.create_index("ix_scan_hist_comp_history_run", "scan_historical_comparison_history", ["comparison_run_id"], unique=False)
    op.create_index("ix_scan_hist_comp_history_type", "scan_historical_comparison_history", ["event_type"], unique=False)
    op.create_index("ix_scan_hist_comp_history_ck", "scan_historical_comparison_history", ["event_checksum"], unique=False)
