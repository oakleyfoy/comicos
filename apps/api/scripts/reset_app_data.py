...
RESET_TARGETS: tuple[ResetTarget, ...] = (
    ...
    ResetTarget("convention_mode_events", models.ConventionModeEvent),
    ResetTarget("convention_activities", models.ConventionActivity),
    ResetTarget("convention_inventory_stages", models.ConventionInventoryStage),
    ResetTarget("convention_booths", models.ConventionBooth),
    ResetTarget("convention_sessions", models.ConventionSession),
    ResetTarget("quick_sale_events", models.QuickSaleEvent),
    ResetTarget("quick_sale_payments", models.QuickSalePayment),
    ResetTarget("quick_sale_line_items", models.QuickSaleLineItem),
    ResetTarget("quick_sales", models.QuickSale),
    ResetTarget("mobile_ops_events", models.MobileOpsEvent),
    ResetTarget("mobile_ops_diagnostics", models.MobileOpsDiagnostic),
    ResetTarget("mobile_ops_metrics", models.MobileOpsMetric),
    ResetTarget("mobile_ops_snapshots", models.MobileOpsSnapshot),
    ResetTarget("mobile_device_security_events", models.MobileDeviceSecurityEvent),
    ResetTarget("mobile_device_access_logs", models.MobileDeviceAccessLog),
    ResetTarget("mobile_device_security_policies", models.MobileDeviceSecurityPolicy),
    ResetTarget("mobile_device_trust_states", models.MobileDeviceTrustState),
    ResetTarget("mobile_analytics_events", models.MobileAnalyticsEvent),
    ResetTarget("mobile_usage_trends", models.MobileUsageTrend),
    ResetTarget("mobile_usage_metrics", models.MobileUsageMetric),
    ResetTarget("mobile_analytics_snapshots", models.MobileAnalyticsSnapshot),
    ResetTarget("scan_events", models.ScanEvent),
    ResetTarget("intake_staging_records", models.IntakeStagingRecord),
    ResetTarget("scan_lookup_results", models.ScanLookupResult),
    ResetTarget("scan_captures", models.ScanCapture),
    ResetTarget("offline_inventory_events", models.OfflineInventoryEvent),
    ResetTarget("offline_sync_conflicts", models.OfflineSyncConflict),
    ResetTarget("offline_sync_queue", models.OfflineSyncQueue),
    ResetTarget("offline_inventory_changes", models.OfflineInventoryChange),
    ResetTarget("offline_inventory_records", models.OfflineInventoryRecord),
    ResetTarget("mobile_foundation_events", models.MobileFoundationEvent),
    ResetTarget("offline_sync_contracts", models.OfflineSyncContract),
    ResetTarget("mobile_sessions", models.MobileSession),
    ResetTarget("mobile_devices", models.MobileDevice),
