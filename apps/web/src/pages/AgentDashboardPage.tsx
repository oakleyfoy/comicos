        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 xl:grid-cols-[1fr,1fr]">
            <section className="rounded-2xl border border-white/10 bg-slate-950/35 p-4">
              <h3 className="text-sm font-semibold text-white">Recommendations generated by type</h3>
            ...
            <section className="rounded-2xl border border-white/10 bg-slate-950/35 p-4">
              <h3 className="text-sm font-semibold text-white">Snapshot coverage</h3>
    ...
    <AppShell>
      ...
      {loading ? (
        ...
        <div className="mt-6 space-y-6">
          ...
          />
          {detailLoading ? (
            <section className="rounded-3xl border border-white/10 bg-slate-900/65 p-5 text-sm text-slate-300">
