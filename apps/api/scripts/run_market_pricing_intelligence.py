"""P89-02 generate market pricing snapshots."""
...
from app.services.p89_market_pricing_service import generate_market_price_snapshots


def main() -> int:
    parser = argparse.ArgumentParser(description="P89 Market Pricing Intelligence runner")
    ...
    with Session(engine) as session:
        ...
        for user in users:
            ...
            summary = generate_market_price_snapshots(
                session,
