...
function Stat({ label, value }: { label: string; value: string | number }): JSX.Element {
  ...
  return (
    ...
    <div className="flex flex-col gap-0.5 border-l border-white/10 pl-4 first:border-l-0 first:pl-0">
...
export function CollectionInsightsSummaryStrip(props: {
  ...
  if (error) {
    ...
    return (
      ...
      <section className="mt-5 rounded-2xl border border-rose-400/30 bg-rose-950/20 px-4 py-3 text-sm text-rose-100">
  ...
  return (
    ...
    <section
      ...
      className="mt-5 rounded-2xl border border-white/10 bg-slate-900/55 px-5 py-4 shadow-lg shadow-black/10"
    ...
    >
      ...
      <div className="flex flex-wrap items-baseline justify-between gap-2">
        ...
        <h2 className="text-sm font-semibold text-white">Collection snapshot</h2>
