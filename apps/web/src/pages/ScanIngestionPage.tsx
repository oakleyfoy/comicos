    ...
    <AppShell>
      ...
      <section className="mt-6 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm shadow-xl shadow-black/15">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <h2 className="text-sm font-semibold text-slate-900">Latest batch detail</h2>
            <p className="mt-1 text-xs text-slate-400">
          ...
          <>
            <div className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                ...
                <p className="mt-2 text-2xl font-semibold text-slate-900">#{batch.id}</p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                <p className="text-[11px] uppercase tracking-[0.16em] text-slate-500">Images</p>
                <p className="mt-2 text-2xl font-semibold text-slate-900">{batch.image_count}</p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                <p className="text-[11px] uppercase tracking-[0.16em] text-slate-500">Failures</p>
                <p className="mt-2 text-2xl font-semibold text-slate-900">{batch.failed_count}</p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                <p className="text-[11px] uppercase tracking-[0.16em] text-slate-500">Duplicates</p>
                <p className="mt-2 text-2xl font-semibold text-slate-900">{batch.duplicate_count}</p>
              </div>
            </div>
