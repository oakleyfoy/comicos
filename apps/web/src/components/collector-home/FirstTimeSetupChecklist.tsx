...
function buildTasks(status: P91CollectorHomeSetupStatusRead): TaskDef[] {
  return [
    {
      id: "import",
      title: "Add your first comics",
      description: "Import a saved retailer order, scan your comics, or add them manually so ComicOS can build your inventory.",
      cta: "Add comics",
    ...
    },
    {
      ...
      description: "Check any imported books that still need attention before they enter your portfolio.",
      cta: "Review imports",
      to: "/retailer-orders",
